...
mixin _$Language {
 ...
 String get name; LanguageProficiency get proficiency;
...
@useResult
$Res call({
 String name, LanguageProficiency proficiency
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  LanguageProficiency proficiency)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Language() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  LanguageProficiency proficiency)  $default,) {final _that = this;
switch (_that) {
case _Language():
return $default(_that.name,_that.proficiency);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  LanguageProficiency proficiency)?  $default,) {final _that = this;
switch (_that) {
case _Language() when $default != null:
return $default(_that.name,_that.proficiency);case _:
  return null;
...
class _Language implements Language {
  const _Language({required this.name, required this.proficiency});
