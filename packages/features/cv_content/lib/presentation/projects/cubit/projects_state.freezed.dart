...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<Project> projects)?  loaded,TResult Function( AppException exception)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _InitialState() when initial != null:
return initial();case _LoadingState() when loading != null:
return loading();case _LoadedState() when loaded != null:
return loaded(_that.projects);case _ErrorState() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<Project> projects)  loaded,required TResult Function( AppException exception)  error,}) {final _that = this;
switch (_that) {
case _InitialState():
return initial();case _LoadingState():
return loading();case _LoadedState():
return loaded(_that.projects);case _ErrorState():
return error(_that.exception);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<Project> projects)?  loaded,TResult? Function( AppException exception)?  error,}) {final _that = this;
switch (_that) {
case _InitialState() when initial != null:
return initial();case _LoadingState() when loading != null:
return loading();case _LoadedState() when loaded != null:
...
class _InitialState implements ProjectsState {
  const _InitialState();
...
class _LoadingState implements ProjectsState {
  const _LoadingState();
...
class _LoadedState implements ProjectsState {
...
/// @nodoc
abstract mixin class _$LoadedStateCopyWith<$Res> implements $ProjectsStateCopyWith<$Res> {
...
class _ErrorState implements ProjectsState {
...
@override
String toString() {
  return 'ProjectsState.error(exception: $exception)';
}
...
/// @nodoc
abstract mixin class _$ErrorStateCopyWith<$Res> implements $ProjectsStateCopyWith<$Res> {
