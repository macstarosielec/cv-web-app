...
import 'package:admin_content/presentation/work_experience/view/widgets/work_experience_content.dart';
...
class _WorkExperienceListViewState extends State<WorkExperienceListView>
  ...
  Widget _buildContent(List<WorkExperience> experiences) {
    ...
    return WorkExperienceContent(
      ...
      editingExperience: _editingExperience,
      listItemAnimation: _listItemAnimation,
      onEdit: _onEdit,
      onSave: _onSave,
