...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<WorkExperience> workExperiences)?  loaded,TResult? Function( List<WorkExperience> workExperiences)?  saving,TResult? Function( AppException exception)?  error,}) {final _that = this;
switch (_that) {
case _InitialState() when initial != null:
return initial();case _LoadingState() when loading != null:
return loading();case _LoadedState() when loaded != null:
...
@override
String toString() {
  return 'AdminWorkExperienceState.error(exception: $exception)';
}
